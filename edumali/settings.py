"""
Django settings for edumali project.
...
JAZZMIN_SETTINGS = {
    ...
    "custom_links": {
        "students": [
            {"name": "Exporter élèves", "url": "export_students", "icon": "fas fa-file-export", "permissions": ["students.view_student"]}
        ],
        "payments": [
            {"name": "Rappels Paiements", "url": "send_payment_reminder", "icon": "fas fa-bell", "permissions": ["payments.view_payment"]}
        ],
    },
